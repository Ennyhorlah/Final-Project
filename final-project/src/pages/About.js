  ...
  return (
    <div>
      <img src="https://cdn.hashnode.com/res/hashnode/image/upload/v1675675022077/6af7d0aa-bcb2-4a71-9447-6152695a4465.png" alt="About"
        className="w-full h-full object-cover rounded-md shadow-lg mx-auto"
        style={{width:"1200px", height:"600px"}}/>
      <h1 className="flex justify-center text-2xl text-blue-500 font-bold m-5 rounded-md">About JSONPlaceholder</h1>
